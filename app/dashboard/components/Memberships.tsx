...
export function Memberships() {
  const [activeView, setActiveView] = useState<"list" | "detail" | "types">(
    "list"
  );
  ...
  if (activeView === "detail" && selectedMembership) {
    return (
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        defaultValue={selectedMembership.description}
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      />
                    </div>
  ...
  if (activeView === "types") {
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900">Membership Types</h2>
          <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-96">
              ...
              <div className="space-y-4">
                <input
                  type="text"
                  placeholder="Type Code (e.g., TIERED)"
                  value={newType.code}
                  onChange={(e) =>
                ...
                <tr key={type.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div className="flex space-x-2">
                      ...
                      <button
                        className="text-red-600 hover:text-red-900"
                        disabled={type.activeMemberships > 0}
                        title={
                          type.activeMemberships > 0
                            ? "Cannot delete type with active memberships"
                            : ""
                        }
                      >
                        Delete
